...
export const initialState = {"reflex___state____state": {"is_hydrated_rx_state_": false, "router_rx_state_": {"session": {"client_token": "", "client_ip": "", "session_id": ""}, "headers": {"host": "", "origin": "", "upgrade": "", "connection": "", "cookie": "", "pragma": "", "cache_control": "", "user_agent": "", "sec_websocket_version": "", "sec_websocket_key": "", "sec_websocket_extensions": "", "accept_encoding": "", "accept_language": "", "raw_headers": {}}, "page": {"host": "", "path": "", "raw_path": "", "full_path": "", "full_raw_path": "", "params": {}}, "url": "", "route_id": ""}}, "reflex___state____state.app___states___global_state____global_state": {"available_jobs_rx_state_": [], "client_ipfs_urls_rx_state_": [], "client_jobs_rx_state_": [], "client_uploaded_images_rx_state_": [], "current_job_rx_state_": null, "current_user_rx_state_": null, "current_view_rx_state_": "create", "is_creating_job_rx_state_": false, "is_loading_balance_rx_state_": false, "is_loading_jobs_rx_state_": false, "job_description_rx_state_": "", "job_latitude_rx_state_": 0.0, "job_location_rx_state_": "", "job_longitude_rx_state_": 0.0, "mode_label_rx_state_": "Client Mode", "show_landing_rx_state_": true, "uploaded_image_rx_state_": "", "user_mode_rx_state_": true, "wallet_address_rx_state_": "", "wallet_balance_rx_state_": 0.0, "worker_jobs_rx_state_": [], "worker_stats_rx_state_": {}}, "reflex___state____state.reflex___state____frontend_event_exception_state": {}, "reflex___state____state.reflex___state____on_load_internal_state": {}, "reflex___state____state.reflex___state____update_vars_internal_state": {}}

export const defaultColorMode = "light"
export const ColorModeContext = createContext(null);
export const UploadFilesContext = createContext(null);
export const DispatchContext = createContext(null);
export const StateContexts = {reflex___state____state: createContext(null),reflex___state____state__app___states___global_state____global_state: createContext(null),reflex___state____state__reflex___state____frontend_event_exception_state: createContext(null),reflex___state____state__reflex___state____on_load_internal_state: createContext(null),reflex___state____state__reflex___state____update_vars_internal_state: createContext(null),};
...
const [reflex___state____state__app___states___global_state____global_state, dispatch_reflex___state____state__app___states___global_state____global_state] = useReducer(applyDelta, initialState["reflex___state____state.app___states___global_state____global_state"])
...
"reflex___state____state.app___states___global_state____global_state": dispatch_reflex___state____state__app___states___global_state____global_state,
...
createElement(StateContexts.reflex___state____state__app___states___global_state____global_state,{value: reflex___state____state__app___states___global_state____global_state},
